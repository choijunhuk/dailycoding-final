...
ALTER TABLE users ADD COLUMN equipped_background VARCHAR(50) NULL DEFAULT NULL;
ALTER TABLE users ADD COLUMN avatar_url_custom VARCHAR(500) NULL DEFAULT NULL;
