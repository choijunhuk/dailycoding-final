...
-- 유저 정보 확장
ALTER TABLE users
  ADD COLUMN IF NOT EXISTS nickname            VARCHAR(50)                         NULL     UNIQUE,
  ADD COLUMN IF NOT EXISTS nickname_changed_at DATETIME                            NULL,
  ADD COLUMN IF NOT EXISTS profile_visibility  ENUM('public','private') NOT NULL   DEFAULT 'public',
  ADD COLUMN IF NOT EXISTS post_visibility     ENUM('public','private') NOT NULL   DEFAULT 'public',
  ADD COLUMN IF NOT EXISTS achievement         VARCHAR(100)                        NULL;
...
ALTER TABLE post_replies
  ADD COLUMN IF NOT EXISTS decocon_id VARCHAR(50) NULL;
