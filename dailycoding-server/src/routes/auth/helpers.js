...
export async function findOrCreateOAuthUser({ provider, oauthId, email, username, avatarUrl }) {
  ...
  if (byEmail) {
    throw new Error('This email is already registered with a different login method. Please use your existing login method or link your social account in settings.');
  }
