...
import onboardingPlanRouter from './onboardingPlan.js';
import classesRouter from './classes.js';
import aiMentorRouter from './aiMentor.js';
import battlePracticeBotRouter from './battlePracticeBot.js';
...
export function registerRoutes(app) {
  ...
  app.use('/api', generalLimiter, onboardingPlanRouter);
  app.use('/api/classes', generalLimiter, classesRouter);
  app.use('/api/ai/mentor', aiLimiter, aiMentorRouter);
  app.use('/api/battles', battleLimiter, battlePracticeBotRouter);
  app.use('/api/og', generalLimiter, ogRouter);
