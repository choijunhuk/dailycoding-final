...
export const PLAN_META = {
  free: {
    ...
    desc: '모든 문제 풀이를 바로 시작하는 개인용 플랜',
    summary: ['전체 문제 풀이', `AI 힌트 ${AI_DAILY_QUOTA}회/일`, '기본 통계'],
    features: [
      { label: '전체 문제 풀이', included: true },
...
export const PRICING_FAQ = [
  ...
  { q: '결제는 어떻게 진행되나요?', a: '로그인 후 플랜을 선택하면 Stripe 안전 결제 페이지로 이동합니다. 카드 정보를 입력하면 즉시 구독이 시작되며, 영수증은 이메일로 자동 발송됩니다.' },
