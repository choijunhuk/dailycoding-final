...
const PLAN_META_BILINGUAL = {
  ...
  pro: {
    ...
    highlight: true,
    summary: {
      ko: ['무제한 AI 힌트', '광고 없음', '프로필 보상'],
      en: ['Unlimited AI hints', 'No ads', 'Profile rewards'],
    },
    features: [
      { ko: 'Free 플랜 전체 포함', en: 'Everything in Free', included: true },
      { ko: '무제한 AI 힌트', en: 'Unlimited AI hints', included: true },
      { ko: '광고 없는 풀이 화면', en: 'Ad-free solving screens', included: true },
      { ko: '프로필 보상 전시', en: 'Profile reward showcase', included: true },
  ...
  team: {
    ...
    summary: {
      ko: ['팀 대시보드', '커스텀 콘테스트', '멤버 관리'],
      en: ['Team dashboard', 'Custom contests', 'Member management'],
    },
    features: [
      ...
      { ko: '초대 링크로 팀 합류', en: 'Join teams by invite link', included: true },
      { ko: '멤버 관리', en: 'Member management', included: true },
      { ko: '팀 이름 및 권한 관리', en: 'Team name and role management', included: true },
      { ko: '팀별 문제 풀이 현황', en: 'Team solving progress', included: true },
    ],
    compactPrice: {
